...
const HeroIcon = refundHero.icon;
  ...
  return (
          ...
          <div className="bg-pink-600 text-white rounded-3xl p-10 text-center">
            ...
            <p className="mt-4 text-pink-100">
              {refundCTA.description}
            </p>

            <Link
to={refundCTA.button.link}              className="inline-block mt-8 bg-white text-pink-600 px-8 py-4 rounded-xl font-semibold hover:scale-105 transition"
            >
{refundCTA.button.text}
            </Link>
